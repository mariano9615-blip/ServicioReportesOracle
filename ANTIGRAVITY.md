...
- **Fechas**: `FecUpd` viene del JSON como `MM/dd/yyyy` (InvariantCulture). Siempre parsear con `CultureInfo.InvariantCulture` y mostrar como `dd/MM/yyyy`. `PrimeraVezVisto`/`UltimaVezVisto` son ISO 8601 — mostrar solo `HH:mm` en grillas.
